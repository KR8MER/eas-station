...
"""CPU utilization and frequency snapshot."""
...
def _collect_cpu_info() -> Dict[str, Any]:
    """Sample CPU core count, frequency and utilization.

    Non-blocking CPU sample: ``cpu_percent(interval=None)`` returns the delta
    since the previous call. Because callers cache the snapshot for ~30 s,
    the resulting numbers are meaningful 30-second averages without ever
