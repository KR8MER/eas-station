    ...
    'redis': {
        ...
        'variables': [
            ...
            },
            {
                ...
                'description': 'Full Redis connection URL (alternative to individual settings)',
    ...
    'location': {
        ...
        'variables': [
            ...
            },
            {
                ...
                'label': 'FIPS Codes',
                'type': 'textarea',
                'description': 'Comma-separated FIPS codes for your coverage area (e.g., 039137)',
    ...
    'icecast': {
        ...
        'variables': [
            ...
            },
            {
                ...
                'type': 'text',
                'default': 'icecast',
                'description': 'Icecast server hostname for container-to-container communication (use "icecast" for Docker)',
            ...
            },
            {
                ...
                'type': 'text',
                'description': 'Hostname reported in Icecast server configuration. Leave empty to auto-detect.',
            ...
            },
            {
                ...
                'type': 'text',
                'description': 'CRITICAL: Public IP or hostname for external access (e.g., 207.148.11.5). Required for remote listeners.',
