...
def iter_route_modules() -> Iterable[RouteModule]:
    ...
    yield RouteModule("routes_alert_trail", alert_trail.register)
    ...
    yield RouteModule("routes_broadcast_control", broadcast_control.register)
    ...
    yield RouteModule("routes_now_playing", routes_now_playing.register)
