    ...
    groups=(
        NavGroup(
            ...
            items=(
                ...
                NavItem(
                    label="Alert-Boundary Intersections",
                    icon="fas fa-draw-polygon",
                    endpoint="dashboard.admin_intersections",
                    description="Recalculate and inspect CAP alert / boundary geometry intersections.",
                    permissions=(SYSTEM_CONFIGURE,),
                ),
                NavItem(
                    label="Zone Catalog",
                    icon="fas fa-map-marked-alt",
                    endpoint="zones_admin.zone_management",
                    description="NOAA public-forecast zone codes used for zone-based alert matching.",
                    permissions=(SYSTEM_CONFIGURE,),
                ),
            ),
        ),
        ...
        NavGroup(
            ...
            items=(
                ...
                NavItem(
                    label="GPIO Statistics",
                    icon="fas fa-chart-line",
                    endpoint="dashboard.gpio_statistics_page",
                    description="Relay activation counts and history.",
                    permissions=(GPIO_VIEW,),
                ),
                NavItem(
                    label="GPIO Interlocks",
                    icon="fas fa-lock",
                    endpoint="gpio_interlocks_page",
                    description="Mutual-exclusion groups between GPIO relays.",
                    permissions=(GPIO_VIEW,),
                ),
                NavItem(
                    label="GPIO Pin Map",
                    icon="fas fa-microchip",
                    endpoint="gpio_pin_map",
                    description="Live state of every configured GPIO pin.",
                    permissions=(GPIO_VIEW,),
                ),
            ),
        ),
        ...
        NavGroup(
            ...
            items=(
                ...
                NavItem(
                    ...
                    endpoint="sms_compliance_page",
                    description="SMS/text notification consent, opt-out and messaging policy.",
                    requires_auth=False,
                ),
                NavItem(
