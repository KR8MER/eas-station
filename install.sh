...
ui_banner "Bare Metal Installer" "" "$LOG_FILE"
...
ICECAST_PORT=8000
# External port advertised in stream URLs. Keep equal to ICECAST_PORT unless
# a reverse proxy listens on a different public port for Icecast.
ICECAST_EXTERNAL_PORT=8000
...
echo -e "    EAS Decoder: ${BOLD}sudo journalctl -u eas-station-audio.service -f${NC}"
