...
## [2.187.0] - 2026-08-23 - Remove Admin Dashboard's Operations tab (phase 2 of consolidation)
...
- **Alert Purge was an orphaned page** -- had no navigation entry anywhere,
  ...
  Remaining tabs (Data, System, Broadcast's encoder form, Security's user
  management) still need the same treatment.
