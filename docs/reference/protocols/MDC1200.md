...
> **Implementation:** [`app_utils/mdc1200.py`](https://github.com/KR8MER/eas-station/blob/main/app_utils/mdc1200.py)
> · **Tests:** [`tests/test_mdc1200.py`](https://github.com/KR8MER/eas-station/blob/main/tests/test_mdc1200.py)
...
[`20260505_add_mdc1200_to_eas_settings`](https://github.com/KR8MER/eas-station/blob/main/app_core/migrations/versions/20260505_add_mdc1200_to_eas_settings.py).
The auto-heal `_PENDING_MIGRATIONS` block in
[`webapp/admin/maintenance/eas_settings.py`](https://github.com/KR8MER/eas-station/blob/main/webapp/admin/maintenance/eas_settings.py) mirrors
