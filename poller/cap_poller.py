...
class CAPPoller:
    ...
    def _parse_feed_payload(self, response: requests.Response) -> List[Dict]:
        try:
            ...
            alerts = _parse_ipaws_xml_feed(response.text, self.logger)
            if alerts:
                    ...
                    try:
                        ...
                        if identifier:
                            ...
                            if not existing_alert:
                                ...
                                duplicates_filtered += 1
                                if _should_replace_alert(existing_alert, alert):
                                    alerts_by_identifier[identifier] = alert
    ...
    def _set_alert_geometry(self, alert: CAPAlert, geometry_data: Optional[Dict]):
        ...
        try:
            ...
            total_vertices = _count_vertices(coords, self.logger)
        ...
        try:
            ...
            for alert_data in alerts_data:
                ...
                try:
                    ...
                    parsed = parse_cap_alert(alert_data, self.logger)
                    if not parsed:
