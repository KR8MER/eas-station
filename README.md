...
[![Version](https://img.shields.io/badge/Version-2.181.0-blueviolet?style=flat-square)](docs/reference/CHANGELOG.md)
...
| ✅ Done | GPIO input triggers — configure a GPIO pin as a physical button that triggers an action (currently: Run RWT Now) |
