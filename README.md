...
[![Version](https://img.shields.io/badge/Version-2.182.0-blueviolet?style=flat-square)](docs/reference/CHANGELOG.md)
...
| ✅ Done | GPIO input triggers — configure a GPIO pin as a physical button that triggers an action (Run RWT Now, Forward Last Alert) |
